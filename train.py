...
def parse_args():
    ...
    parser.add_argument('-m', '--model', type=str, default='fcn_resnet50', 
                        choices=['fcn_resnet50', 'deeplabv3_resnet50', 'fcn_resnet101', 'deeplabv3_resnet101'],
                        help='Modelo a ser treinado')
    parser.add_argument('-p', '--pretrained', action='store_true',
                        help='Usar pesos pré-treinados')
    parser.add_argument('-b', '--batch-size', type=int, default=TRAINING_CONFIG['batch_size'],
                        help='Tamanho do batch')
    parser.add_argument('-e', '--epochs', type=int, default=TRAINING_CONFIG['num_epochs'],
                        help='Número de épocas')
    parser.add_argument('--lr', type=float, default=TRAINING_CONFIG['lr'],
                        help='Taxa de aprendizado')
    parser.add_argument('-n', '--exp-name', type=str, default='experiment',
